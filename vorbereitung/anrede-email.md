---
title: "Workshop-Vorbereitungsmail (manuell versenden)"
draft: true
---

Internes Dokument für die Workshop-Leitung. Wird nicht im Site-Output verlinkt; per Copy-Paste in Outlook oder das BFH-Mailsystem übernommen.

## Version 1: Zwei Wochen vor dem Workshop

**Betreff:** Vorbereitung KI in der Lehre Advanced (Workshop in zwei Wochen)
...
Ohne diese drei Dinge funktioniert der Workshop nicht: wir arbeiten an eurem konkreten Material. Falls das schwierig ist, meldet euch.
...
## Version 2: Eine Woche vor dem Workshop (Erinnerung)

**Betreff:** Erinnerung: Lehraufgabe für den Advanced-Workshop nächste Woche
...
Falls ihr keine passende Aufgabe findet, haben wir Backup-Material aus sechs Disziplinen (Pflege, Pädagogik, Wirtschaft, Sozialarbeit, Engineering, Statistik).
...
## Anmerkungen für die Workshop-Leitung

- Die "drei Dinge"-Liste ist nicht-verhandelbar. Wer mit nichts kommt, soll auf ein Backup-Szenario zurückgreifen, aber das funktioniert nicht so gut wie eigenes Material. Den Hinweis in der ersten Mail ernst meinen.
- Das Beispiel im zweiten Absatz der ersten Mail ist absichtlich aus dem Statistik-Worked-Example. So sehen Teilnehmende, was in Block 1 vorgeführt wird, schon im Vorbereitungsmaterial.
- Wenn die Workshop-Sprache zwischen "du" und "Sie" gewechselt werden muss (je nach institutionellem Kontext): hier ist konsistent "du / ihr" verwendet. Die Anpassung auf "Sie" wäre eine grosse Suche-und-Ersetze-Operation, falls nötig.
