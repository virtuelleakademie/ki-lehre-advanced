...
**3. API-Aufruf mit Schema-Constraint.** Das `Exercise`-Objekt wird zusammen mit dem P(know)-Wert an die Anthropic-Claude-API geschickt. Das System nutzt Pydantic, um Claude zu zwingen, in einem bestimmten Format zu antworten: nicht freier Text, sondern eine Struktur mit `hint_text`, `rationale`, `next_step_suggestion`, `metacognitive_prompt`, `estimated_difficulty`. Das ist das "Output bedürfnissgemäss einschränken" aus den offiziellen Lernzielen.
