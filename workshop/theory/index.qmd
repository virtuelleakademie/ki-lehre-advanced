...
|--------|-------------|------------------------|
| **Worked Example Effect** | Novices learn better from studying complete solutions than solving problems independently (effect size: 0.52) | AI should generate complete, step-by-step solutions for novices to study |
| **Expertise Reversal Effect** | As expertise increases, worked examples become less effective and can be counterproductive | Personalize based on learner level - more guidance for novices, less for experts |
