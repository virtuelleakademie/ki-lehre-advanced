...
Die Typologie stammt aus dem **KLI-Framework** (Knowledge-Learning-Instruction, @koedingerKnowledgeLearningInstructionFrameworkBridging2012). Dort werden die drei Typen unter den Bezeichnungen *Memory-and-Fluency*, *Induction-and-Refinement* und *Understanding-and-Sense-Making* eingeführt. Die deutschen Bezeichnungen *Faktenwissen / Klassifikationswissen / Erklärungswissen* sind im pädagogischen Sprachgebrauch geläufiger.
...
[Refresher-Präsentation: Von der kognitiven Architektur zum KI-gestützten Scaffolding](https://virtuelleakademie.github.io/ki-lehre-refresher/){target="_blank"}
