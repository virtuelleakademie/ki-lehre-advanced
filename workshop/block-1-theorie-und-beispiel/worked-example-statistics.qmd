...
Eine kommentierte Anwendung der LLM-as-Novice-Methode auf eine konkrete Statistik-Aufgabe. Du beobachtest, wie ein als strukturierter Novize geprompter LLM die in einer Aufgabenstellung enthaltenen, aber nicht explizit benannten Voraussetzungen enumeriert. Die Aufgabe stammt aus einem Bachelor-Statistikkurs; sie dient hier ausschliesslich als Demonstrationsbeispiel.
...
**Lernziel:** Die Lernende soll zeigen, dass sie die konditionale Bedeutung der Formulierung "kontrolliert für" verstanden hat und einen Regressionskoeffizienten unter Berücksichtigung weiterer Prädiktoren angemessen interpretieren kann.
...
Unterscheide zwischen Fakten zum Abrufen, Klassifikationen zum Erkennen,
Prozeduren zum Ausführen und konzeptionellen Verständnissen.
...
- Die Daten in R einlesen, deren Verteilung und Zusammenhang grafisch prüfen, eine multiple Regression anpassen.
...
- Die konditionale Interpretation der Formulierung "kontrolliert für": $b_1$ ist der Effekt von $X_1$ *bei gleicher Mathenote*, nicht der bereinigte Effekt nach einem Eingriff.
