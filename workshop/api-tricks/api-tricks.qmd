...
OpenAI erlaubt [API Assistenten](https://platform.openai.com/assistants) zu definieren (analog zu CostumGPT), um sie mit minimalem Aufwand in verschiedenen Codes zu verwenden.
