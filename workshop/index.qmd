...
1. **Laptop with modern browser** (Chrome, Firefox, Safari, Edge)
...
We use **two different applications** with distinct purposes:
...
**Direct OpenAI API + Pydantic:**

- Simple, transparent code
- Focus on pedagogical design, not framework complexity
- Type-safe structured outputs
- Industry-standard pattern

**Gradio for Production:**
...
**Understanding** of Cognitive Load Theory principles (worked example + personalisation effects)
...
**Recognition of the pattern** - What's involved in building educational AI tools

**You will NOT have:** A deployed production application, nor will you be a proficient Python developer

**You WILL have:** Conceptual understanding of how these tools work and what's possible
:::
