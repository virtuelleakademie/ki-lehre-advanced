...
In this exercise, you will practice how to prompt and set parameters for the OpenAI API.

- generate a system prompt 
- play around with the temperature parameter
- play around with the top_p parameter
- play around with the max_tokens parameter
- play around with the top_k parameter

- make the LLM creative
- make the LLM less creative

- what is more suitable for factual responses, a high or a low temperature?
